...
def observation_from_dom_payload(
    ...
    *,
    ...
    producer supplies a stable message signature (or reliable tail text), CWS derives
    DOM-silence time across observations instead of trusting the ChatGPT Send/Stop button.
    """
