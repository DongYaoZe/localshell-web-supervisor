...
The previous web chat message may have failed after side effects were already executed.
...
def recommend(
    ...
    return RecoveryRecommendation(
        ...
        "candidate for a new web chat turn after explicit reconciliation; V0 does not auto-dispatch",
        prompt=prompt,
        evidence=assessment.evidence,
    )
