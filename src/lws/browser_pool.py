...
class ProbeResourcePolicy:
    ...
    because web chat state detection may depend on them. Large visual-only resources can be
    blocked to reduce RAM/network pressure on a dedicated LWS-owned probe context.
    """
