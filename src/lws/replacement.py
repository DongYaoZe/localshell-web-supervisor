    ...
    if candidate is not None and candidate.status == WorkerLeaseStatus.CANDIDATE:
        if state.current_worker_id is None:
            ...
            if eligibility.eligible:
                ...
                # LWS may abandon the still-fresh old conversation lease and claim the candidate.
...
def complete_replacement(
    ...
    *,
    ...
    """Publish LWS generation takeover only after the supported LSM takeover is observable."""
